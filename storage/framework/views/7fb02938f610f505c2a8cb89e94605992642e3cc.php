      ...
      <form class="" action="<?php echo e(Route('booking_order_action')); ?>" role="form" method="POST" >
                ...
                <div class="col-md-6 col-xs-6">
                  <div class="form-group " >
                    ...
                    <div class="" >
                      ...
                      <input type="hidden" name="companyIdForBookingOrder" value="<?php echo e($companyId); ?>">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <div class="form-group">
                    <input type="text" name="orderNo" class="form-control" placeholder="OS Number" title="OS Number">
                  </div>
                </td>
