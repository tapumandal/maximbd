...
<?php $__env->startSection('page_heading',trans('others.add_page_footer_title_label')); ?>
			...
			<div class="col-md-8 col-md-offset-2">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('footer_action')); ?>">
							...
							<div class="form-group">
								<label class="col-md-4 control-label"><?php echo e(trans('others.enter_title_label')); ?></label>
								<div class="col-md-6">
